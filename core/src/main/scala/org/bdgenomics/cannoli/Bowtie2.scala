...
class Bowtie2Args extends Args4jBase {
  ...
  @Args4jOption(required = false, name = "-image", usage = "Container image to use. Defaults to quay.io/biocontainers/bowtie2:2.5.3--py39h6fed5c7_0.")
  var image: String = "quay.io/biocontainers/bowtie2:2.5.3--py39h6fed5c7_0"
